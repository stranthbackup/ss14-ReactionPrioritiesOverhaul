...
public sealed partial class ShuttleNavControl : BaseShuttleControl
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        Matrix3.MultiplyBackwards(posMatrix, ourEntMatrix, out var ourWorldMatrix);
            ...
            fixturesQuery.HasComponent(ourGridId.Value))
        {
            ...
            Matrix3.MultiplyBackwards(in ourGridMatrix, in ourWorldMatrixInvert, out var matrix);
        ...
        foreach (var grid in _grids)
        {
            ...
            Matrix3.MultiplyBackwards(in gridMatrix, in ourWorldMatrixInvert, out var matty);
